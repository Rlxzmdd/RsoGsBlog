<div class="admin-content">
    <div class="am-g blog-g-fixed am-u-lg-8 am-u-md-8 am-u-sm-centered ">
        <h3 style="padding-top: 20px">修改您的文章:</h3>
        <hr/>
        <form method="post" class="am-form" action="/admin/editArticle">
            ...
            <hr/>
            <textarea id="editor_text" name="editor_text" placeholder="请输入文章"
                      autofocus=""><?php echo $content ?></textarea>
            <br/>
            <div class="am-cf">
